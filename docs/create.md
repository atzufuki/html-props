...
The generated `deno.json` includes several useful tasks:

- `deno task dev`: Starts the development server with HMR.
- `deno task bundle`: Bundles the application for production.
