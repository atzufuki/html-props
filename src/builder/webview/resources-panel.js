(function () {
  ...
  function renderCategory(categoryId, categoryTitle, iconClass, elements, isCustom = false, categoryPath = null) {
    ...
    if (isCustom && categoryPath) {
      ...
      createBtn.addEventListener('click', () => {
        createComponentInCategory(categoryPath);
      });
  ...
  /**
   * Create new component (main button)
   */
  ...
  /**
   * Create component in specific category
   */
  function createComponentInCategory(categoryPath) {
    vscode.postMessage({
