...
/**
 * Type for the HTMLPropsMixin function that adds HTML props handling to a custom element.
 */
type HTMLPropsMixinType = <SuperClass extends Constructor<HTMLElement> = Constructor<HTMLElement>>(
  superClass: SuperClass,
) => <Props>() =>
  & Constructor<
    InstanceType<SuperClass> & HTMLPropsExtra<Props>,
    Props
  >
 ...
 */
export const HTMLPropsMixin: HTMLPropsMixinType = <SuperClass>(superClass: SuperClass) => {
  /**
